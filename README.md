...
<p align="center">
If you like the idea click ⭐ on the repo and <a href="https://twitter.com/intent/tweet?text=Nice%20xontrib%20for%20the%20xonsh%20shell!&url=https://github.com/karimstekelenburg/xontrib-assistant" target="_blank">tweet</a>.
</p>
...
```xsh
xpip install xontrib-assistant
# or: xpip install -U git+https://github.com/karimstekelenburg/xontrib-assistant
```
...
```xsh
$XONTRIBS_AUTOLOAD_DISABLED = ["assistant-tools", ]
...
* Write a message to: [xonsh Gitter chat](https://gitter.im/xonsh/xonsh?utm_source=xontrib-template&utm_medium=xontrib-template-promo&utm_campaign=xontrib-template-promo&utm_content=xontrib-template-promo), [Twitter](https://twitter.com/intent/tweet?text=xonsh%20is%20a%20Python-powered,%20cross-platform,%20Unix-gazing%20shell%20language%20and%20command%20prompt.&url=https://github.com/karimstekelenburg/xontrib-assistant), [Reddit](https://www.reddit.com/r/xonsh), [Mastodon](https://mastodon.online/).
